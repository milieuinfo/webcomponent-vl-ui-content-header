(function (global, factory) {
  ...
  var GenerateGallery = function GenerateGallery() {
    _classCallCheck(this, GenerateGallery);
    ...
    container.appendChild(item3); // UI

    var ui = document.createElement('div');
    vl.util.addClass(ui, pswpUIClass);
    vl.util.addClass(ui, pswpUIHiddenClass);
    scrollwrap.appendChild(ui); // Top bar

    var topbar = document.createElement('div');
    vl.util.addClass(topbar, pswpTopBarClass);
    ui.appendChild(topbar); // Counter

    var counter = document.createElement('div');
    vl.util.addClass(counter, pswpCounterClass);
    topbar.appendChild(counter); // Close button

    var closeButton = document.createElement('button');
    var closeButtonAlt = document.createElement('span');
    closeButton.setAttribute('type', 'button');
    closeButtonAlt.setAttribute('class', "".concat(vl.ns, "u-visually-hidden"));
    ...
    closeButton.appendChild(closeButtonAlt); // Zoom button

    var zoomButton = document.createElement('button');
    var zoomButtonAlt = document.createElement('span');
    zoomButton.setAttribute('type', 'button');
    zoomButtonAlt.setAttribute('class', "".concat(vl.ns, "u-visually-hidden"));
    ...
    zoomButton.appendChild(zoomButtonAlt); // Preloader
    ...
    preloaderCut.appendChild(preloaderDonut); // Share modal
    ...
    shareModal.appendChild(shareTooltip); // left button

    var leftButton = document.createElement('button');
    var leftButtonAlt = document.createElement('span');
    leftButton.setAttribute('type', 'button');
    leftButtonAlt.setAttribute('class', "".concat(vl.ns, "u-visually-hidden"));
    ...
    leftButton.appendChild(leftButtonAlt); // right button

    var rightButton = document.createElement('button');
    var rightButtonAlt = document.createElement('span');
    rightButton.setAttribute('type', 'button');
    rightButtonAlt.setAttribute('class', "".concat(vl.ns, "u-visually-hidden"));
    ...
    rightButton.appendChild(rightButtonAlt); // Caption
  ...
  var lightboxClass = "js-".concat(vl.ns, "lightbox"),
      lightboxCaptionClass = "js-".concat(vl.ns, "lightbox-caption"),
      pswpClass$1 = "".concat(vl.ns, "pswp"),
      lbLink = "".concat(vl.ns, "lightbox__link"),
      dataPrefix = "data-".concat(vl.ns),
      lbAtt = "".concat(dataPrefix, "lightbox"),
      lbItemAtt = "".concat(lbAtt, "-item"),
      lbSizeAtt = "".concat(lbAtt, "-size");
  var pswpElement = null;
  /**
   * Private Functions
   */

  var _createLightbox = function _createLightbox(lb) {
    if (lb === null) {
      return false;
    }

    pswpElement = document.querySelector(".".concat(pswpClass$1)); // If pswp container is available do nothing, else generate the necessary elements
  ...
  var _parseThumbnailElements = function _parseThumbnailElements(el) {
    var thumbElements = el.querySelectorAll("[".concat(lbItemAtt, "]"));
    var items = [];
    vl.util.each(thumbElements, function (thumb) {
      var width = 0;
      var height = 0;

      if (thumb.hasAttribute(lbSizeAtt)) {
        var size = thumb.getAttribute(lbSizeAtt).split('x');
        width = parseInt(size[0], 10);
        height = parseInt(size[1], 10);
      }

      var item = {
        src: thumb.querySelector(".".concat(lbLink)).getAttribute('href'),
        w: width,
        h: height
      }; // Figcaption

      var figcaption = thumb.querySelector(".".concat(lightboxCaptionClass));
  ...
  var _onThumbnailsClick = function _onThumbnailsClick(e) {
    e.preventDefault();
    ...
    if (!eTarget.hasAttribute(lbItemAtt)) {
      clickedListItem = eTarget.closest("[".concat(lbItemAtt, "]"));
    }
    ...
    var clickedGallery = clickedListItem.closest(".".concat(lightboxClass, ", [").concat(lbAtt, "]")),
        childNodes = clickedGallery.querySelectorAll("[".concat(lbItemAtt, "]")),
  ...
  var _calculateIdealSize = function _calculateIdealSize(item, instance) {
    var baseHeight = instance.height;
    var baseWidth = instance.width;
    var calculatedBaseHeight;
    var calculatedBaseWidth;
  ...
  var _openPhotoSwipe = function _openPhotoSwipe(index, galleryElement, disableAnimation, fromURL) {
  ...
  function () {
    ...
    _createClass(LightBox, [{
      ...
      value: function dressAll() {
        ...
        var elements = document.querySelectorAll(".".concat(lightboxClass, ":not([data-").concat(vl.ns, "js-dress=\"false\"]),\n      [").concat(lbAtt, "]:not([data-").concat(vl.ns, "js-dress=\"false\"])"));
        vl.util.each(elements, function (element, i) {
